    ...
    public static class Fail
    {
        ...
        public static void TwoDocumentsOneError()
        {
            ...
            var expected = """
                Expected no diagnostics, found:
                SA1309 Field '_value' must not begin with an underscore
                  at line 4 and character 29 in file C1.cs | private readonly int ↓_value = 1;
        ...
        public static void WithExpectedDiagnosticWithWrongId()
        {
            var code = """
                ...
                """;
            var expected = """
                SyntaxNodeAnalyzer does not produce a diagnostic with ID 'ID2'.
        ...
        public static void WithExpectedDiagnosticWhenOneReportsError()
        {
            ...
            var expected = """
                ...
                Field Message format
                  at line 4 and character 29 in file C.cs | private readonly int ↓wrongName = 1;
        ...
        public static void WhenCompilerWarnings()
        {
            ...
            var expected = """
                ...
                CS8603 Possible null reference return.
                  at line 4 and character 29 in file C.cs | public string M() => ↓null;
