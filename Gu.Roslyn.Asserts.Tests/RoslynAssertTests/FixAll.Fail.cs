...
public static partial class FixAll
{
    public static class Fail
    {
            ...
            var expected = """
                ...
                Missed:
                  SA1309 Field '_f2' must not begin with an underscore
                    at line 5 and character 29 in file C.cs | private readonly int ↓_f2 = 2;
        ...
        public static void SingleDocumentExplicitTitle()
        {
            ...
            var fix = new DoNotUseUnderscoreFix();
            var expected = """
                Did not find a code fix with title WRONG.
                Found:
                Rename to: 'value'
        ...
        public static void SingleDocumentOneErrorWrongPosition()
        {
            ...
            var expected = """
                ...
                Expected:
                  SA1309 
                    at line 4 and character 16 in file C.cs | private ↓readonly int _f = 1;
                Actual:
                  SA1309 Field '_f' must not begin with an underscore
                    at line 4 and character 29 in file C.cs | private readonly int ↓_f = 1;
        ...
        public static void FixDoesNotMatchAnalyzer()
        {
            ...
            var expected = """
                NopAnalyzer does not produce diagnostics fixable by DoNotUseUnderscoreFix.
        ...
        public static void SingleDocumentOneErrorErrorInFix()
        {
            ...
            var exception = Assert.Throws<AssertException>(() => RoslynAssert.FixAll(analyzer, fix, before, after));
            var expected = """
                Applying fixes one by one failed.
                Mismatch on line 5 of file C.cs.
        ...
        public static void TwoDocumentsOneErrorErrorInFix()
        {
            ...
            var analyzer = new FieldNameMustNotBeginWithUnderscore();
            var fix = new DoNotUseUnderscoreFix();
            var exception = Assert.Throws<AssertException>(() => RoslynAssert.FixAll(analyzer, fix, new[] { c1, before }, new[] { c1, after }));
            var expected = """
                Applying fixes one by one failed.
                Mismatch on line 7 of file C2.cs.
        ...
        public static void WhenFixIntroducesCompilerDiagnostics()
        {
            ...
            var expected = """
                The fixed code by InsertMethodFix contains compiler diagnostics.
                ...
                CS0518 Predefined type 'System.Object' is not defined or imported
                  at line 4 and character 15 in file C.cs | public ↓EventHandler? M() => null;
        ...
        public static void WhenFixDoesNotDoAnything()
        {
            ...
            var exception = Assert.Throws<AssertException>(() => RoslynAssert.FixAll(analyzer, fix, before, after));
            var expected = """
                The fixed code by EmptyFix contains compiler diagnostic.
                  - fix the code used in the test
                  - suppress the warning in the test code using for example pragma
                  - suppress the warning by providing Settings to the assert.
                CS0414 The field 'C._f' is assigned but its value is never used
                  at line 3 and character 25 in file C.cs | private readonly int ↓_f = 1;
                First source file with diagnostic is:
                namespace N;
                class C
                {
        ...
        public static void WhenFixChangesCodeButAfterProducesDiagnostic()
        {
            ...
            var exception = Assert.Throws<AssertException>(() => RoslynAssert.FixAll(analyzer, fix, before, after));
            var expected = """
                The fixed code by InitializeFieldWithTwoFix contains compiler diagnostic.
                  - fix the code used in the test
                  - suppress the warning in the test code using for example pragma
                  - suppress the warning by providing Settings to the assert.
                CS0414 The field 'C._f' is assigned but its value is never used
                  at line 3 and character 25 in file C.cs | private readonly int ↓_f = 2;
                First source file with diagnostic is:
                namespace N;
                class C
                {
