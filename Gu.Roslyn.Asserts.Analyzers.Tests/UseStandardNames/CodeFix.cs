...
namespace N
{
    ...
    public static class Valid
    {
        ...
        public static void M1()
        {
            ...
            RoslynAssert.CodeFix(Analyzer, Fix, ExpectedDiagnostic, new[] { Code.PlaceholderAnalyzer, before }, new[] { Code.PlaceholderAnalyzer, after }, suppressWarnings: new[] { "CS1701" });
        }
